...
public class ZobristHasher {
    ...
    public long calculateFullZorbistKey(PlayerColor color, Board board) {
        long hash = getCastleRightsKey(board.getCastlingRights());
    ...
    public void updateEnPassant(int epT) {
    ...
    public void updatePlayer(PlayerColor c) {
        key ^= getSideKey(c);
    }

    public void forceKey(long zk) {
        key = zk;
    }
