...
class ZobristHasherTest {
    @Test public void testFenHash() {
        ...
        assertThat(game.getZobristKey()).isEqualTo(game.resetZobristKey());
    }

    @Test public void testDefaultHash() {
        Game game = new Game();
        assertThat(game.getZobristKey()).isNotNull();
        assertThat(game.getZobristKey()).isEqualTo(4516155336704681926L);
    }
    ...
    @Test public void move() {
        ...
        assertThat(game.getZobristKey()).isEqualTo(game.resetZobristKey());
        game.undo();
        assertThat(game.getZobristKey()).isEqualTo(game.resetZobristKey()).isEqualTo(originalKey);
    }
